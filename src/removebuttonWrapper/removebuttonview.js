...
export default class FormView extends View {
	constructor( locale ) {
		...
		this.abbrInputView = this._createInput( 'Button text' );
		this.titleInputView = this._createInput( 'Button title' );
		this.hextInputView = this._createInput( 'HEX color' );
		this.hexTextInputView = this._createInput( 'HEX Text Color' );

		this.saveButtonView = this._createButton( 'OK', 'ck-button-save' );
